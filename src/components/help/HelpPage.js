    ...
    return (
        <div className='help-page'>
            ...
            <p className="text">
                ...
                останньої подорожі. Ця інформація може бути цікава для "пересічників" або ж для людей
                що заїхали на територію України з європейським паспортом, щоб не перевищити дозволений
                час перебування.
            </p>
            <br/>
            <p className="text">
